...
<html lang="en">
  ...
  <div class="container">
  <div id="Live" class=" mt-2 p-1 rounded row rtl">
        <div class="col-md-12 text-left">
          <p class="bg-light-green  ">پخش زنده</p>
        </div>
        <div class="col-form-label col-md-5 icon-container">
          <img src="./public/img/cover-live.jpg" class="filter-contrast image m-auto" alt="Image">
          <div class="overlay">
            <img class="play-icon" src="./public/img/color-play.svg">
          </div>
        </div>
  ...
  <div id="Archives">
    <div class="bg-white mt-2 p-1 rounded row rtl">
        <div class="col-form-label col-md-5 icon-container">
          <img src="./public/img/cover-live.jpg" class="image m-auto " alt="Image">
          
        </div>
        <div class="col text-right">
          <div class="row pt-2 ">
            <div class="col-md-12 text-left FA-numbers">
              <p>1402-03-05</p>
            </div>
            <div class="col-md-12">
              <h5>عنوان</h5>
            ...
            <div class="col-md-12">
              <p>توضیحات</p>
              <button class="btn btn-show mb-2 pull-left rounded">دکمه</button>
            </div>
          </div>
        </div>
    </div>
  ...
  <div id="Archives">
    <div class="bg-white mt-2 p-1 rounded row rtl">
        <div class="col-form-label col-md-5 icon-container">
          <img src="./public/img/cover-live.jpg" class="image filter-contrast m-auto" alt="Image">
          <div class="overlay">
            <img class="play-icon" src="./public/img/color-play.svg">
          </div>
        </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/jalali-moment@latest/dist/jalali-moment.min.js"></script>
