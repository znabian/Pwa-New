    ...
    <div class="col" style="background: #ffffff;width: 85%;margin: 0 auto;padding: 10px;box-shadow: 0px 0px 6px rgba(45,45,45,0.13);border-radius: 15px;padding-top: 20px;">
      ...
      <img id="castle_Image" style="height:25%;width:25%;margin: auto auto;border-radius: 11px;" >
        <div style="text-align: center;margin: auto auto;">
          <h4 id="castle_Title" class="text-end" style="font-family: 'Peyda ExtBd';padding-top: 0;font-size: 16px;margin-bottom: 0px;">کاخ اجتماعی</h4>
          <small id="castle_Description" class="d-flex justify-content-start" style="font-family: 'Peyda ExtLt';font-size: 12px;">رئالیتی شو "رفیق شفیق"</small>
        </div>
      </div>
...
<!-- <script src="./public/js/Reality.js?h=9a9b13"></script> -->
<script src="./js-decode/Reality.js?h=9a9b19"></script>
  <script>
